...
<aside class="w-64 bg-indigo-700 text-white flex flex-col">
    ...
    <nav class="flex-1 p-4 space-y-2">
        ...
        <a href="{{ route('getSettings') }}" wire:navigate wire:current="bg-indigo-800 font-medium"
            class="block py-2.5 px-4 rounded-lg hover:bg-indigo-600">Settings</a>
    ...
    <div class="p-4 border-t border-indigo-500 text-sm text-indigo-200">
        Logged in as <br><span class="font-semibold">@livewire('sidebar')</span>
    </div>
</aside>
